 ...
 * @author João Felipe
 */
public class VSobre extends javax.swing.JFrame {

    /**
     * Creates new form VSobre
     */
    public VSobre() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Software desenvolvido por estudantes\ndo curso de Ciência da Computação da\nUniversidade Estadual do Centro-Oeste\n(UNICENTRO).\n\nDesenvolvedores:\n    Juliano Carvalho\n    João Felipe P. Bini\n    Gabriel Lucas Fedacz\n    \nE-mail para contato:sleeptreeweb@gmail.com");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VSobre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
