/*
 * Está classe é um framework que achamos na internet para inserir um jComboBox com um calendário
 * para o usuário utilizar na hora de escolher data.
 * Site Download: http://toedter.com/jcalendar/ 
 * 
 * VJCalendar.java
 * 18/11/2009
 */
...
public class VJCalendar extends JComboBox {
  ...
  public VJCalendar(boolean showActualDate) {
    /*
  ...
  private class DatePopup extends BasicComboPopup {
    ...
    public void show(Component invoker, int x, int y) {
      constructDatePopup();
      super.show(VJCalendar.this, VJCalendar.this.getWidth() - 194, VJCalendar.this.getHeight());
    }
  ...
  public void updateUI() {
    ComboBoxUI comboBoxUI = (ComboBoxUI) UIManager.getUI(VJCalendar.this);
